...
import { appOpties, bordItems, escalaties, orkestratorComments, } from '../board.js';
import { standaardPaden } from '../orkestrator-instellingen.js';
import { leesEscalatie } from './orkestreer.js';
import { bouwBrief, parseRunlog, } from '../regie-brief.js';
...
export function haalEscalatieContext(geescaleerdeItems, cwd) {
    const context = [];
...
export function brief(nu = new Date(Date.now())) {
    ...
    const escalatieSet = escalaties() ?? new Set();
