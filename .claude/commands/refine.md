...
4. Bepaal de functionele architectuur: welk gedrag komt erbij, welke randgevallen,
...
8. Schrijf de uitwerking volgens de template naar een tijdelijk bestand en werk
...
9. Sluit af met de slices op één regel per stuk, en zeg dat de volgende stap is:
